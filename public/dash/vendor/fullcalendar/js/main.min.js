...
var FullCalendar = (function (e) {
  ...
  (cl.prototype.classes = {
    ...
    (cl.prototype.iconOverrideOption = "scholarvaultFontAwesome"),
    (cl.prototype.iconOverrideCustomButtonOption = "scholarvaultFontAwesome"),
    (cl.prototype.iconOverridePrefix = "fa-");
  var dl = lo({ themeClasses: { scholarvault: cl } });
  var pl = lo({
    eventSourceDefs: [
      {
        parseMeta: function (e) {

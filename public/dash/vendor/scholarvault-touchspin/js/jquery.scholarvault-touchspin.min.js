/*
 *  scholarvault TouchSpin - v4.2.5
 *  A mobile and touch friendly input spinner component for scholarvault 3 & 4.
 *  http://www.virtuosoft.eu/code/scholarvault-touchspin/
 *
    ...
    return this.each(function () {
      ...
      !(function () {
        ...
        (i = j.extend(
          ...
          (function () {
            ...
            c.data("initvalue", t).val(t),
              ...
              n.hasClass("input-group")
                ? (function (t) {
                    t.addClass("scholarvault-touchspin");
                    var n,
                      o,
                      s = c.prev(),
                      p = c.next(),
                      a =
                        '<span class="input-group-addon input-group-prepend scholarvault-touchspin-prefix input-group-prepend scholarvault-touchspin-injected"><span class="input-group-text">' +
                        i.prefix +
                        "</span></span>",
                      e =
                        '<span class="input-group-addon input-group-append scholarvault-touchspin-postfix input-group-append scholarvault-touchspin-injected"><span class="input-group-text">' +
                        i.postfix +
                        "</span></span>";
                    ...
                    s.hasClass("input-group-prepend")
                      ? ((n =
                          '<button class="' +
                          i.buttondown_class +
                          ' scholarvault-touchspin-down scholarvault-touchspin-injected" type="button">' +
                          i.buttondown_txt +
                          "</button>"),
                        s.append(n))
                      : ((n =
                          '<span class="input-group-btn input-group-prepend scholarvault-touchspin-injected"><button class="' +
                          i.buttondown_class +
                          ' scholarvault-touchspin-down" type="button">' +
                          i.buttondown_txt +
                          "</button></span>"),
                        j(n).insertBefore(c));
                    ...
                    p.hasClass("input-group-append")
                      ? ((o =
                          '<button class="' +
                          i.buttonup_class +
                          ' scholarvault-touchspin-up scholarvault-touchspin-injected" type="button">' +
                          i.buttonup_txt +
                          "</button>"),
                        p.prepend(o))
                      : ((o =
                          '<span class="input-group-btn input-group-append scholarvault-touchspin-injected"><button class="' +
                          i.buttonup_class +
                          ' scholarvault-touchspin-up" type="button">' +
                          i.buttonup_txt +
                          "</button></span>"),
                        j(o).insertAfter(c));
                ...
                : (function () {
                    ...
                    t = i.verticalbuttons
                      ? '<div class="input-group ' +
                        n +
                        ' scholarvault-touchspin scholarvault-touchspin-injected"><span class="input-group-addon input-group-prepend scholarvault-touchspin-prefix"><span class="input-group-text">' +
                        i.prefix +
                        '</span></span><span class="input-group-addon scholarvault-touchspin-postfix input-group-append"><span class="input-group-text">' +
                        i.postfix +
                        '</span></span><span class="input-group-btn-vertical"><button class="' +
                        i.buttondown_class +
                        " scholarvault-touchspin-up " +
                        i.verticalupclass +
                        '" type="button">' +
                        i.verticalup +
                        '</button><button class="' +
                        i.buttonup_class +
                        " scholarvault-touchspin-down " +
                        i.verticaldownclass +
                        '" type="button">' +
                        i.verticaldown +
                        "</button></span></div>"
                      : '<div class="input-group scholarvault-touchspin scholarvault-touchspin-injected"><span class="input-group-btn input-group-prepend"><button class="' +
                        i.buttondown_class +
                        ' scholarvault-touchspin-down" type="button">' +
                        i.buttondown_txt +
                        '</button></span><span class="input-group-addon scholarvault-touchspin-prefix input-group-prepend"><span class="input-group-text">' +
                        i.prefix +
                        '</span></span><span class="input-group-addon scholarvault-touchspin-postfix input-group-append"><span class="input-group-text">' +
                        i.postfix +
                    ...
                    (u = j(t).insertBefore(c)),
                      j(".scholarvault-touchspin-prefix", u).after(c),
                      c.hasClass("input-sm")
          ...
          (o = {
            down: j(".scholarvault-touchspin-down", u),
            up: j(".scholarvault-touchspin-up", u),
            input: j("input", u),
            prefix: j(".scholarvault-touchspin-prefix", u).addClass(
              i.prefix_extraclass
            ),
            postfix: j(".scholarvault-touchspin-postfix", u).addClass(
          ...
          c.on("touchspin.destroy", function () {
            ...
            (t = c.parent()),
              _(),
              c.off(".touchspin"),
              t.hasClass("scholarvault-touchspin-injected")
                ? (c.siblings().remove(), c.unwrap())
                : (j(".scholarvault-touchspin-injected", t).remove(),
                  t.removeClass("scholarvault-touchspin")),
            ...
            !(function (t) {
              (function (t) {
                if (((i = j.extend({}, i, t)), t.postfix)) {
                  var n = c.parent().find(".scholarvault-touchspin-postfix");
                  0 === n.length && a.insertAfter(c),
                    c
                      .parent()
                      .find(".scholarvault-touchspin-postfix .input-group-text")
                      .text(t.postfix);
                }
                if (t.prefix) {
                  var o = c.parent().find(".scholarvault-touchspin-prefix");
                  0 === o.length && p.insertBefore(c),
                    c
                      .parent()
                      .find(".scholarvault-touchspin-prefix .input-group-text")
                      .text(t.prefix);
                }
                b();
              })(t),

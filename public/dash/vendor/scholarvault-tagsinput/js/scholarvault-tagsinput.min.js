/*
 * scholarvault-tagsinput v0.7.1 by Tim Schlechter
 *
 */
...
!(function (a) {
  ...
  function b(b, c) {
    (this.isInit = !0),
      ...
      (this.$container = a('<div class="scholarvault-tagsinput"></div>')),
      (this.$input = a(
              ...
              if ((f.$element.trigger(o), !o.cancel)) {
                ...
                c || f.pushVal(),
                  (f.options.maxTags === f.itemsArray.length ||
                    ...
                    f.$container.addClass("scholarvault-tagsinput-max"),
    ...
    remove: function (b, c, d) {
      ...
      c || e.pushVal(),
        e.options.maxTags > e.itemsArray.length &&
          e.$container.removeClass("scholarvault-tagsinput-max"),
...
//# sourceMappingURL=scholarvault-tagsinput.min.js.map

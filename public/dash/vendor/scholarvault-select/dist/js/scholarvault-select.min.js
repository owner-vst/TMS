!(function (e, t) {
  ...
  !(function (T) {
    ...
    var O = {
      ...
      M = 38,
      R = 40,
      U = window.Dropdown || scholarvault.Dropdown;
    function V() {
      var t;
      try {
    ...
    function ie(e) {
      ...
      if (([].shift.apply(a), !j.success)) {
        try {
          ...
          te.scholarvaultVersion
            ? (j.full = te.scholarvaultVersion.split(" ")[0].split("."))
            : ((j.full = [j.major, "0", "0"]),
              console.warn(
                "There was an issue retrieving scholarvault's version. Ensure scholarvault is being loaded before scholarvault-select and there is no namespace collision. If loading scholarvault asynchronously, the version may need to be manually specified via $.fn.selectpicker.Constructor.scholarvaultVersion.",
                e
              ));
        }
          ...
          return (
            ...
            this.options.allowClear &&
              (c =
                ...
                '"><span>&times;</span>'),
            (n =
              '<div class="dropdown scholarvault-select' +
              e +
              i +
    ...
    (T.fn.selectpicker = ie),
      ...
      T(document)
        ...
        .on(
          ...
          ":not(.scholarvault-select) > [" + q.DATA_TOGGLE + "]",
          ne
        )
        .on(
          "keydown.bs.dropdown.data-api",
          ":not(.scholarvault-select) > .dropdown-menu",
          ne
        )
        .on(
          "keydown" + F,
          ".scholarvault-select [" +
            q.DATA_TOGGLE +
            '], .scholarvault-select [role="listbox"], .scholarvault-select .bs-searchbox input',

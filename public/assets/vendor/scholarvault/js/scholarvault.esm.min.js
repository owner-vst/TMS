...
function scholarvaultHandler(e, t) {
  return function i(n) {
    return (
      (n.delegateTarget = e),
...
function scholarvaultDelegationHandler(e, t, i) {
  return function n(s) {
...
function addHandler(e, t, i, n, s) {
  ...
  const _ = getUidEvent(r, t.replace(namespaceRegex, "")),
    h = o ? scholarvaultDelegationHandler(e, i, n) : scholarvaultHandler(e, i);
...
//# sourceMappingURL=scholarvault.esm.min.js.map

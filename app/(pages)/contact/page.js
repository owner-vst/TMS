...
function Contact() {
  ...
  return (
    <div>
  <div className="dz-bnr-inr dz-bnr-inr-sm text-center overlay-primary-dark" style={{backgroundImage: 'url(/assests/images/banner/bnr1.jpg)'}}>
          ...
          <div className="info-box style-1 ">
            ...
            <div className=" dz-social style-1 wow fadeInUp" data-wow-delay="0.2s">
              ...
              <ul className="social-icon">
                <li><a className="social-btn" target="_blank" href="https://www.facebook.com"><i className="fa-brands fa-facebook-f" /></a></li>
                <li><a className="social-btn" target="_blank" href="https://www.instagram.com"><i className="fa-brands fa-instagram" /></a></li>
                <li><a className="social-btn" target="_blank" href="https://twitter.com"><i className="fa-brands fa-twitter" /></a></li>
                <li><a className="social-btn" target="_blank" href="https://www.youtube.com"><i className="fab fa-youtube" /></a></li>
              </ul>
            </div>
          </div>
        </div>
                ...
                <div className="row ">
                  ...
                  <div className="col-md-6">
                    <div className="input-group wow fadeInUp" data-wow-delay="2.1s">
                      <input name="dzSubject" required type="text" className="form-control" placeholder="Subject" />
                      <div className="invalid-feedback">
                  ...
                  <div className="col-md-12">
                    <div className="input-group wow fadeInUp" data-wow-delay="2.2s">
                      <textarea name="dzMessage" rows={5} required className="form-control" placeholder="Type Message..." defaultValue={""} />
                      <div className="invalid-feedback">
  ...
  <div className="accordion-item">
    ...
    <div id="collapseOne" className="accordion-collapse collapse show" data-bs-parent="#accordionExample">
      <div className="accordion-body">
        <strong>The User need to sign in first.</strong> Upon successful login ,the will be redirect to his dashboard where he can upload thesis 
      </div>
    </div>
  </div>
  <div className="accordion-item">
    ...
    <div id="collapseTwo" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
      <div className="accordion-body">
        <strong>It will be depend on the Scholar who reviews the thesis.</strong> Generally it wont take more than a week to get the review.
      </div>
    </div>
  </div>
  <div className="accordion-item">
    ...
    <div id="collapseThree" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
      <div className="accordion-body">
        <strong>Yes,Thesis can be downloaded.</strong> these will also be added to stats for the thesis
      </div>
    </div>
  </div>
</div>

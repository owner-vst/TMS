    ...
    <div className="card-body">
      ...
      >
        ...
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body-text">
              No, once you submit your thesis, you cannot edit it. Please ensure
        ...
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body-text">
              ...
              process. This includes confirmation of submission, updates on the
              review status, and any feedback or required revisions.
            </div>
          </div>
        </div>
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body-text">
              No, there is no fee for submitting your thesis. You can submit as
              many theses as you need without any cost.
            </div>
          </div>
        </div>
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body-text">
              ...
              our support team via the "Contact Us" page. You can also check our
              FAQs for troubleshooting tips.
            </div>
          </div>
        </div>
      </div>
